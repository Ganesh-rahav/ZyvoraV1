  ...
  return (
    <div className="rounded-2xl border border-[#1E293B] bg-[#1E293B]/60 p-8 shadow-[0_0_60px_0_rgba(0,0,0,0.5)] backdrop-blur-sm">
      ...
      <div className="mb-6 text-center">
        ...
        <p className="mt-1 text-sm text-[#64748B]">Continue your transformation.</p>
      </div>
      ...
      <div className="my-5 flex items-center gap-3">
        ...
        <span className="text-xs text-[#475569]">or sign in with email</span>
        <div className="h-px flex-1 bg-[#1E293B]" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
        ...
        <div>
          ...
          <input
            ...
            className="h-11 w-full rounded-lg border border-[#334155] bg-[#0F172A] px-4 text-sm text-white placeholder-[#475569] transition-colors focus:border-[#3B82F6] focus:outline-none focus:ring-1 focus:ring-[#3B82F6]"
            required
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="h-11 w-full rounded-lg border border-[#334155] bg-[#0F172A] px-4 pr-10 text-sm text-white placeholder-[#475569] transition-colors focus:border-[#3B82F6] focus:outline-none focus:ring-1 focus:ring-[#3B82F6]"
              required
            />
            <button
              type="button"
        ...
        {error && (
          <p
            className="rounded-lg border border-[#EF4444]/30 bg-[#EF4444]/10 px-4 py-2 text-xs text-[#FCA5A5]"
            role="alert"
          >
            {error}
          </p>
        ...
        <motion.button
          ...
          className={`flex h-11 w-full items-center justify-center gap-2 rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3B82F6] ${
            canSubmit && !loading
      ...
      <p className="mt-5 text-center text-sm text-[#64748B]">
        ...
        <Link href="/register" className="font-medium text-[#60A5FA] hover:underline">
          Get started free
        </Link>
      </p>
    </div>
